 ...
 * SVN $Id: jackhmmer.c 3152 2010-02-07 22:55:22Z eddys $
 */
#include "p7_config.h"
...
/* Selecting the alphabet rather than autoguessing it */
  { "--amino",      eslARG_NONE,   FALSE, NULL, NULL,  ALPHOPTS,    NULL,  NULL,            "input alignment is protein sequence data",                     3 },
  { "--dna",        eslARG_NONE,   FALSE, NULL, NULL,  ALPHOPTS,    NULL,  NULL,            "input alignment is DNA sequence data",                         3 },
  { "--rna",        eslARG_NONE,   FALSE, NULL, NULL,  ALPHOPTS,    NULL,  NULL,            "input alignment is RNA sequence data",                         3 },
/* Control of scoring system */
  { "--popen",      eslARG_REAL,  "0.02", NULL, "0<=x<0.5",NULL,    NULL,  NULL,            "gap open probability",                                         4 },
  { "--pextend",    eslARG_REAL,   "0.4", NULL, "0<=x<1",  NULL,    NULL,  NULL,            "gap extend probability",                                       4 },
  { "--mxfile",     eslARG_INFILE,  NULL, NULL, NULL,      NULL,    NULL,  NULL,            "substitution score matrix [default: BLOSUM62]",                4 },
/* Control of reporting thresholds */
  ...
  { "--domE",       eslARG_REAL,  "10.0", NULL, "x>0",     NULL,    NULL,  DOMREPOPTS,      "report domains <= this E-value threshold in output",           5 },
  { "--domT",       eslARG_REAL,   FALSE, NULL, NULL,      NULL,    NULL,  DOMREPOPTS,      "report domains >= this score cutoff in output",                5 },
/* Control of inclusion (significance) thresholds */
  { "--incE",       eslARG_REAL, "0.001", NULL, "x>0",     NULL,    NULL,  INCOPTS,         "consider sequences <= this E-value threshold as significant",  6 },
  { "--incT",       eslARG_REAL,   FALSE, NULL, NULL,      NULL,    NULL,  INCOPTS,         "consider sequences >= this score threshold as significant",    6 },
  { "--incdomE",    eslARG_REAL, "0.001", NULL, "x>0",     NULL,    NULL,  INCDOMOPTS,      "consider domains <= this E-value threshold as significant",    6 },
  { "--incdomT",    eslARG_REAL,   FALSE, NULL, NULL,      NULL,    NULL,  INCDOMOPTS,      "consider domains >= this score threshold as significant",      6 },
...
serial_master(ESL_GETOPTS *go, struct cfg_s *cfg)
{
  ...
  else                                        abc = esl_alphabet_Create(eslAMINO);
  ...
  if (! esl_sqfile_IsRewindable(dbfp)) 
    esl_fatal("Target sequence file %s isn't rewindable; jackhmmer requires that it is", cfg->dbfile);
